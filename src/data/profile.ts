...
export const talks: Talk[] = [
  {
    ...
    highlights: [
      ...
      'Architecture Patterns: Trade-offs balancing Cost, Latency, and Safety',
      'Sequential, Iterative & Parallel Workflows',
      'Capstone: Building the complete Content Creation Studio',
      'Deployment: Vertex AI Agent Engine + Cloud Run (React + FastAPI)',
    ],
    sessions: [
      {
